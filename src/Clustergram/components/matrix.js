...
const Matrix = function(network_data, svg_elem, params) {
    ...
    let tile_data = filter(network_data.links,
        function (num) {
    ...
    if (params.matrix.tile_type === 'simple') {
        ...
        if (params.network_data.links.length < params.matrix.def_large_matrix) {
            ...
            // make row matrix
            let row_groups = clust_group.selectAll('.row')
        ...
        d3.select(clicked_rect).each(function (d) {
            ...
            if (pos_x != params.matrix.click_hlight_x || pos_y != params.matrix.click_hlight_y) {
                ...
                d3.select(clicked_rect.parentNode)
                    ...
                    .attr('fill', params.matrix.hlight_color)
                    .attr('transform', function () {
                        let tmp_translate = params.matrix.x_scale(pos_x) + params.matrix.x_scale.bandwidth() - hlight_width;
                ...
                d3.select(clicked_rect.parentNode)
                    ...
                    .attr('fill', params.matrix.hlight_color)
                    .attr('transform', function () {
                        let tmp_translate_x = params.matrix.x_scale(pos_x) + hlight_width * 0.99;
    ...
    function draw_simple_tiles(clust_group, tile_data) {
        ...
        // bind tile_data
        let tile = clust_group.selectAll('.tile')
    ...
    function draw_group_tiles(clust_group, tile_data) {
        ...
        tile
            ...
            .attr('d', function () {
                ...
                let start_y = 0;
                let final_y = params.matrix.y_scale.bandwidth() - params.matrix.y_scale.bandwidth() /
                    60;
        ...
        tile
            ...
            .attr('d', function () {
                let start_x = 0;
                let final_x = params.matrix.x_scale.bandwidth();
                let start_y = params.matrix.y_scale.bandwidth() - params.matrix.y_scale.bandwidth() /
                    60;
                let final_y = params.matrix.y_scale.bandwidth() - params.matrix.y_scale.bandwidth() /
                    60;
                let output_string = 'M' + start_x + ', ' + start_y + ' ,   L' +

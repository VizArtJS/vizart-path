...
const VizParams = function(config) {
    ...
    function initialize_visualization(config) {
        ...
        let ini_clust_width = params.viz.svg_dim.width - (params.labels.super_label_width +
        ...
        let ini_clust_height = params.viz.svg_dim.height - (params.labels.super_label_width +
        ...
        params.viz.border_width = params.matrix.x_scale.bandwidth() /
        ...
        params.viz.real_zoom = params.norm_label.width.col / (params.matrix.x_scale.bandwidth() / 2);
    ...
    function parent_div_size_pos(params) {
        let outer_margins = params.viz.expand == false ? params.viz.outer_margins : params.viz.outer_margins_expand;
    ...
    function initialize_matrix(network_data) {
        ...
        each(network_data.row_nodes, function (tmp, row_index) {
            matrix[row_index] = range(network_data.col_nodes.length).map(
                function (col_index) {
                    return {
                        pos_x: col_index,
                        pos_y: row_index,

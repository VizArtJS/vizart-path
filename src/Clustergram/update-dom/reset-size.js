...
const run_reset_visualization_size = function(set_clust_width, set_clust_height, set_margin_left, set_margin_top, parameters) {
    ...
    d3.select('#right_hlight')
        ...
        .attr('transform', function () {
            let tmp_translate = params.matrix.x_scale(params.matrix.click_hlight_x) + params.matrix.rect_width - hlight_width;
    ...
    d3.select('#col_top_hlight')
        ...
        .attr('transform', function () {
            ...
            let tmp_translate_x = -(params.viz.clust.dim.height +
    ...
    svg_group.selectAll('.col_label_click')
        ...
        .attr('d', function () {
            ...
            let start_y = -(params.matrix.rect_width - reduce_rect_width +
